    ...
    override fun onCreateView(
        ...
        loginButton.setOnClickListener(object: View.OnClickListener {
            override fun onClick(p0: View?) {
                /**
                 * TESTING for XmlRpc requests
                 * (odoo) | (AndroidRuntime) for filterting in the logcat console
                 * This should not bet defined in the fragment
                 * Looks like it is not handling well the multiple request in a row (crashes)
                 */
